...
function output_list( $book,$location){
    ...
    if($book == 1){echo '<ul class="booking"><li>Book 1</li><li><a href="?book=2&amp;location=9">Book 2</a></li></ul>';}
    if($book == 2){echo '<ul class="booking"><li><a href="?book=1&amp;location=0">Book 1</a></li><li>Book 2</li></ul>';
    $i=10;}
...
<div class="jumpnav"><a href="#nav">menu</a></div>
   ...
   <main class="content"> 
<h2 class="book-location">Book <?php echo $book; ?></h2>
<?php
...
$content = str_replace('src="media/', 'src="https://raw.githubusercontent.com/mmu-webdesign/Level4-web-term-1/master/CSS/css0'.$book.'/media/', $content);
...
<ul><li><a href="index.php?book=<?php echo $_GET['book']*1; ?>&amp;location=<?php echo ($location-1); ?>">Previous</a></li>
<?php if(($_GET['book']==1&&$location<8)||($_GET['book']==2&&$location<17)){ ?>
<li><a href="index.php?book=<?php echo $_GET['book']*1; ?>&amp;location=<?php echo ($location+1); ?>">Next</a></li></ul>
<?php } ?>
</nav>
</main>
<footer class="page-footer">
<p><a href="https://github.com/mmu-webdesign/Level4-web-term-1">View this content on GitHub</a> &middot; <a href="mailto:webteaching@mmu.ac.uk">webteaching@mmu.ac.uk</a></p>
</footer>
</body>
</html>